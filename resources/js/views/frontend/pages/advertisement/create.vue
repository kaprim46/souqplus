        ...
        >
          ...
          >
            <div>
              ...
              >
                <i class="icon mgc_store_line"></i>
                {{ $t('Create new advertisement') }}
              </h2>
              <p class="text-sm text-gray-600 dark:text-gray-400">
                {{ $t('Create a new advertisement for your business') }}
              </p>
            </div>
          </div>
          <!-- End Header -->
...
const initialForm = (): Advertisement => ({
  category: {},
  city: {},
  comments_count: 0,
  country: {},
...
const form = ref<Advertisement>(initialForm());
const errors = ref({});

const onFormUpdate = (newForm: Advertisement) => {
