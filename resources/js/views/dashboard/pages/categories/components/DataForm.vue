<template>
    <div class="grid gap-4 grid-cols-1 md:grid-cols-2">
        ...
        <div>
            ...
            <p class="text-xs text-red-600 mt-2" v-if="errors.status">
                @{{ errors.status[0] }}
            </p>
        </div>
        <!-- End Form Group -->
        ...
        <div>
            ...
            />
            <p class="text-xs text-red-600 mt-2" v-if="errors.meta_title">
                @{{ errors.meta_title[0] }}
            </p>
        </div>
        ...
        <div>
            ...
            <p class="text-xs text-red-600 mt-2" v-if="errors.meta_robots">
        ...
        <div>
            ...
            />
            <p class="text-xs text-red-600 mt-2" v-if="errors.meta_description">
        ...
        <div>
            ...
            />
            <p class="text-xs text-red-600 mt-2" v-if="errors.meta_keywords">
...
const onCreate = async () => {
    ...
    try {
        const { data } = await axios.post('/dashboard/categories', data_form.value);
...
const onUpdate = async () => {
    ...
    try {
        const { data } = await axios.put(`/dashboard/categories/${data_form.value.id}`, data_form.value);
