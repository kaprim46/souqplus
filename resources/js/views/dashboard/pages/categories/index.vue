                ...
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
                    ...
                    <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex flex-col md:flex-row gap-2">
                            ...
                            <v-button color="green" class="whitespace-nowrap" @click="router.push({ name: 'category.create' })">
                            ...
                            <tr v-if="!categoryStore.isLoading" v-for="category in categoryStore.categories" :key="category.id">
                                ...
                                <td  class="h-px px-6 py-2">
                                    <div class="flex justify-end gap-x-2">
                                        <v-button color="blue" class="whitespace-nowrap" @click="router.push({ name: 'category.edit', params: { id: category.id } })">
...
onBeforeMount(async () => {
    categoryStore.filters.pagination = 1 as number;

    await nextTick(async () => await categoryStore.fetch())
})
</script>
